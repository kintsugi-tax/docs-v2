...
After completing organization setup, the next phase establishes where your clients have tax obligations. This involves creating physical nexus records and economic nexus registrations. All endpoints in this phase use the **Kintsugi SDK**.
...
<Expandable title="🗺️ Nexus & Registration Workflow" icon="diagram">
```mermaid
...
flowchart TD
    Start["🏁 Organization Setup Complete"] --> HasPhysical{"Client has<br/>Physical Presence?"}
    ...
    CheckEconomic -->|No| Monitor["📊 Monitor Sales<br/>for Future Nexus"]
    
    CreateRegistration --> AutoProducts["🔄 Auto-Create Products<br/>(in this application)"]
    AutoProducts --> Ready["✅ Registration Active<br/>Tax Collection Enabled"]
...
flowchart LR
    ...
    subgraph Kintsugi["Kintsugi Platform"]
        NexusDB["🗄️ Nexus Database"]
        RegDB["🗄️ Registration Database"]
