...
<Note>
**Programmatic vs. manual key management.** This endpoint is the programmatic path for white-label/STaaS onboarding and is unchanged. For human/manual key management, partners create and manage keys in the **Partner Experience** under {/* TODO: confirm exact PX label */} **Settings → API Keys** — not in the main Kintsugi app (`app.trykintsugi.com`).
</Note>
