...
- **API Credentials**: A Partner-Organization API key. Manage keys in the Partner Experience under {/* TODO: confirm exact PX label */} **Settings → API Keys**, or programmatically via `POST /v2/partner/api_keys` (see [Authentication and API keys](#authentication-and-api-keys)).
...
Partner-Organization API keys come in two scopes:
...
| Operation | Endpoint |
| --- | --- |
| Create | [`POST /v2/partner/api_keys`](/reference/partners/partner-management/api-keys/create-partner-organization-api-key) |
| List | [`GET /v2/partner/api_keys`](/reference/partners/partner-management/api-keys/list-partner-organization-api-keys) |
| Delete | [`DELETE /v2/partner/api_keys/{api_key_id}`](/reference/partners/partner-management/api-keys/delete-partner-organization-api-key) |
