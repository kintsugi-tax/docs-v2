...
Partner keys are issued with one of two scopes, set at creation:
...
| Operation | Endpoint |
| --- | --- |
| Create a key | [`POST /v2/partner/api_keys`](/reference/partners/partner-management/api-keys/create-partner-api-key) |
| List your keys | [`GET /v2/partner/api_keys`](/reference/partners/partner-management/api-keys/list-partner-api-keys) |
| Delete a key | [`DELETE /v2/partner/api_keys/{api_key_id}`](/reference/partners/partner-management/api-keys/delete-partner-api-key) |
