...
| Operation | Endpoint |
| --- | --- |
| Create a key | [`POST /v2/partner/api_keys`](/reference/partners/partner-management/api-keys/create-client-api-key) |
| List your keys | [`GET /v2/partner/api_keys`](/reference/partners/partner-management/api-keys/list-client-api-keys) |
| Delete a key | [`DELETE /v2/partner/api_keys/{api_key_id}`](/reference/partners/partner-management/api-keys/delete-client-api-key) |
