...
- ✅ An API key from the [Kintsugi Platform](https://app.trykintsugi.com/). **Partners** instead manage keys in the **Partner Experience** under {/* TODO: confirm exact PX label */} **Settings → API Keys** (see [Creating and Managing API Keys](/docs/creating-and-managing-api-keys)).
...
All SDKs use API key authentication. You can get your API key from the [Kintsugi Platform](https://app.trykintsugi.com/). **Partners** manage keys in the **Partner Experience** under {/* TODO: confirm exact PX label */} **Settings → API Keys**.
