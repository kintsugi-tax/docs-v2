...
flowchart TD
    Start["📋 API Endpoint Mapping"] --> TaxCalc
    
    TaxCalc["💰 Tax Calculation"] --> Avalara1["Avalara<br/>POST /transactions/create"]
    TaxCalc --> TaxJar1["TaxJar<br/>POST /taxes"]
    Avalara1 --> MapsTo1["⬇️ Maps To"]
    TaxJar1 --> MapsTo1
    MapsTo1 --> Kintsugi1["✅ Kintsugi<br/>POST /v1/tax/estimate"]
    
    Kintsugi1 --> TransRec
    
    TransRec["📝 Transaction Recording"] --> Avalara2["Avalara<br/>Transaction API"]
    TransRec --> TaxJar2["TaxJar<br/>Transaction API"]
    Avalara2 --> MapsTo2["⬇️ Maps To"]
    TaxJar2 --> MapsTo2
    MapsTo2 --> Kintsugi2["✅ Kintsugi<br/>POST /v1/transactions"]
    
    Kintsugi2 --> CustMgmt
    
    CustMgmt["👥 Customer Management"] --> Avalara3["Avalara<br/>POST /customers"]
    CustMgmt --> TaxJar3["TaxJar<br/>POST /customers"]
    Avalara3 --> MapsTo3["⬇️ Maps To"]
    TaxJar3 --> MapsTo3
    MapsTo3 --> Kintsugi3["✅ Kintsugi<br/>POST /v1/customers"]
    
    Kintsugi3 --> ProdMgmt
    
    ProdMgmt["📦 Product Management"] --> Avalara4["Avalara<br/>TaxCode Assignment"]
    ProdMgmt --> TaxJar4["TaxJar<br/>Product Categories"]
    Avalara4 --> MapsTo4["⬇️ Maps To"]
    TaxJar4 --> MapsTo4
    MapsTo4 --> Kintsugi4["✅ Kintsugi<br/>POST /v1/products"]
    
    style Start fill:#213331,stroke:#213331,stroke-width:3px,color:#FFFFFF
    style TaxCalc fill:#e8f5e9,stroke:#213331,stroke-width:2px,color:#000000
    style TransRec fill:#e8f5e9,stroke:#213331,stroke-width:2px,color:#000000
    style CustMgmt fill:#e8f5e9,stroke:#213331,stroke-width:2px,color:#000000
    style ProdMgmt fill:#e8f5e9,stroke:#213331,stroke-width:2px,color:#000000
    style Avalara1 fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
    style Avalara2 fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
    style Avalara3 fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
    style Avalara4 fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
    style TaxJar1 fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
    style TaxJar2 fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
    style TaxJar3 fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
    style TaxJar4 fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
    style MapsTo1 fill:#4a7c59,stroke:#213331,stroke-width:2px,color:#FFFFFF
    style MapsTo2 fill:#4a7c59,stroke:#213331,stroke-width:2px,color:#FFFFFF
    style MapsTo3 fill:#4a7c59,stroke:#213331,stroke-width:2px,color:#FFFFFF
    style MapsTo4 fill:#4a7c59,stroke:#213331,stroke-width:2px,color:#FFFFFF
    style Kintsugi1 fill:#213331,stroke:#213331,stroke-width:3px,color:#FFFFFF
    style Kintsugi2 fill:#213331,stroke:#213331,stroke-width:3px,color:#FFFFFF
    style Kintsugi3 fill:#213331,stroke:#213331,stroke-width:3px,color:#FFFFFF
    style Kintsugi4 fill:#213331,stroke:#213331,stroke-width:3px,color:#FFFFFF
```
</Expandable>
...
flowchart TD
    ...
    style C fill:#e8f5e9,stroke:#213331,stroke-width:2px,color:#000000
    style D fill:#e8f5e9,stroke:#213331,stroke-width:2px,color:#000000
    style E fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
    style F fill:#ff6b6b,stroke:#213331,stroke-width:3px,color:#FFFFFF
    ...
    style K fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
    style L fill:#FFFFFF,stroke:#213331,stroke-width:2px,color:#000000
